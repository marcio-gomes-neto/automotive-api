...
import AddClaimWithOutsourceUseCase from "../useCase/addClaimWithOutsourceUseCase";

export default class addClaimWithOutsourceController implements IController{
    ...
    public async Handle(request:IRequest){
        const useCaseResponse = new AddClaimWithOutsourceUseCase(this.presenter)
